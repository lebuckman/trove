    ...
    >
      <div className="surface-blur mx-auto flex h-[64px] w-full max-w-xs items-center justify-around rounded-full border border-border px-4 shadow-[0_16px_40px_-12px_rgba(0,0,0,0.6)]">
        <Link
          ...
          aria-label="Home"
          className={cn(
            "tappable flex h-12 w-14 items-center justify-center rounded-2xl",
            isHome && !isProfile ? "text-accent-strong" : "text-text-subtle",
          )}
        >
          <HomeIcon className="h-6.5 w-6.5" />
        </Link>
        ...
        <Link
          ...
          className={cn(
            "tappable flex h-12 w-14 items-center justify-center rounded-2xl",
            isProfile ? "text-accent-strong" : "text-text-subtle",
          )}
        >
          <ProfileIcon className="h-6.5 w-6.5" />
        </Link>
      </div>
    </nav>
  );
